...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <a href="agency.php" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="agency.php" class="nav-link <?php if (!isset($_GET['page'])) echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=dynamic" class="nav-link 
                            <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=route" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=train" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=report" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=payment" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=ads" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=feedback" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=users" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=search" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="agency.php?page=logout" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Agency  Dashboard</h1>
                        </div> 
                    </div> 
                </div> 
            </div>
