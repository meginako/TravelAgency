                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered" id='example1'>
                            ...
                            <tbody>
                                <?php
                                //SELECT *, booked.id as id, payment.date as pd FROM `booked` INNER JOIN payment ON booked.payment_id = payment.id INNER JOIN schedule ON schedule.id = booked.schedule_id  WHERE payment.passenger_id = '$user_id' ORDER BY booked.id DESC
