                ...
                <form method="post">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!--<a href="./pay.php"> </a> onclick="return confirm('You will be directed to make your payment.\nPayment finalizes your booking!')"-->
...
// pay($_POST['schedule_id'],$_POST['total'],'MEGI');

// $payment_id=getPaymentId($_POST['schedule_id']);

// book($_POST['schedule_id'],$_POST['number'],$_POST['class'],$payment_id);
