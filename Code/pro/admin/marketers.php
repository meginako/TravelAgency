                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table style="width: 100%;" id="example1" style="align-items: stretch;"
                                    ...
                                    <tbody>
                                        <?php
                                        $row = connect()->query("SELECT * FROM menager_and_marketing where type = 3 ORDER BY id DESC");
                                        ...
                                        while ($fetch = $row->fetch_assoc()) {
                                            ...
                                            <td>
                                                ...
                                                <a href="admin.php?page=marketers&status=1&id=<?php echo $id; ?>">
                                                    <button
                                                        onclick="return confirm('You are about allowing this marketer be able to login his/her account.')"
                                                ...
                                                <a href="admin.php?page=marketers&status=0&id=<?php echo $id; ?>">
                                                    <button
                                                        onclick="return confirm('You are about denying this marketer access to  his/her account.')"
