                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <tbody>
                                    <?php
                                    $row = $conn->query("SELECT * FROM `feedback` where agency_id = '$agency_id' order by response ASC");
...
if (isset($_POST['send_reply'])) {
    ...
    $id = $_POST['id'];
    if (replyTo($id, $reply)) {
        echo "<script>alert('Reply sent!');window.location='".$_SERVER['PHP_SELF'] . "?page=feedback"."'</script>";
    } else {
        echo "<script>alert('Reply could not be sent!');window.location='".$_SERVER['PHP_SELF'] . "?page=feedback"."'</script>";
    }
}
