                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>Vehicle : <select class="form-control" name="train_id" required
                                                                ...
                                                                <?php
                                                                    $cons = connect()->query("SELECT * FROM train where agency_id = '$agency_id' ");
                                                        ...
                                                        <p>Route : <select class="form-control" name="route_id" required
                                                                ...
                                                                <?php
                                                                    $cond = connect()->query("SELECT * FROM route where agency_id = '$agency_id' ");
...
if (isset($_POST['submit'])) {
    ...
    if (!isset($route_id, $train_id, $first_fee, $second_fee, $date, $time)) {
        ...
        $conn = connect();
        $ins = $conn->prepare("INSERT INTO `schedule`(`agency_id`,`train_id`, `route_id`, `date`, `time`, `first_fee`, `second_fee`) VALUES (?,?,?,?,?,?,?)");
        $ins->bind_param("iiissii",$agency_id, $train_id, $route_id, $date, $time, $first_fee, $second_fee);
        $ins->execute();
...
if (isset($_POST['edit'])) {
    ...
    if (!isset($route_id, $train_id, $first_fee, $second_fee, $date, $time)) {
        ...
        $conn = connect();
        $ins = $conn->prepare("UPDATE `schedule` SET `agency_id`=?,`train_id`=?,`route_id`=?,`date`=?,`time`=?,`first_fee`=?,`second_fee`=? WHERE id = ?");
        $ins->bind_param("iiissiii",$agency_id, $train_id, $route_id, $date, $time, $first_fee, $second_fee, $id);
        $ins->execute();
