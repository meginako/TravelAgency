            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="manager.php" class="nav-link <?php if (!isset($_GET['page'])) echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=dynamic" class="nav-link 
                            <?php
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=report" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=payment" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=feedback" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=search" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="manager.php?page=logout" class="nav-link">
